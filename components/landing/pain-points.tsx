...
function PainPointCard({ point }: { point: (typeof painPoints)[0] }) {
  ...
  return (
    <div
      ...
      className="group bg-card border-border relative cursor-default overflow-hidden rounded-2xl border"
      style={{
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden md:h-56">
        ...
        {/* Number Badge */}
        <span className="text-primary/70 absolute top-4 left-4 font-mono text-xs tracking-widest">
          {point.number}
        </span>
      </div>
      ...
      <div className="relative p-5 md:p-6">
        <p className="text-foreground text-sm leading-relaxed font-medium md:text-base">
          {point.text}
        </p>
      </div>
  ...
  return (
    <section className="bg-background px-6 py-20 md:px-[10%] md:py-28">
      ...
      <div className="mb-14 text-center">
        <span className="text-primary mb-4 inline-block font-mono text-xs tracking-widest uppercase">
          Pain Points
        </span>
